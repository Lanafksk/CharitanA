...
exports.createProject = async (project_data) => {
    ...
    // // Get list of donors to notify
    // const category_subscription_list = await axios.get(
    //     `${API_GATEWAY}/donors/subscribe/categories`, 
    //     {
    //         headers: {
    ...
    // const region_subscription_list = await axios.get(
    //     `${API_GATEWAY}/donors/subscribe/regions`, 
    //     {
    //         headers: {
    //             'internal-api': process.env.INTERNAL_API_KEY
    //         },
    ...
    //     }
    // );
    // console.log('Category subscription list:', category_subscription_list.data);
    // console.log('Region subscription list:', region_subscription_list.data);

    // // Find distinct donors
    // let distinct_donors = [...new Set([...category_subscription_list, ...region_subscription_list])];

    // const donors = await axios.get(
    //     `${API_GATEWAY}/donors`,
    //     {
    //         headers: {
    //             'internal-api': process.env.INTERNAL_API_KEY
    ...
    // let distinct_donors = [];
    // for (let donor of donors.data.data) {
    //     if (donor.categories.includes(result.category) || donor.regions.includes(result.region)) {
    //         distinct_donors.push(donor);
    //     }
    // }

    // for (let donor of distinct_donors) {
    //     try {
    //         await axios.post(
    //             `${API_GATEWAY}/emails/send-project-notification`, 
    //             {
    //                 headers: {
    //                     'internal-api': process.env.INTERNAL_API_KEY
    //                 },
...
async function validateProjectData(project_data) {
    ...
    try {
        const response = await axios.get(`${API_GATEWAY}/charity/id/${project_data.charity_id}`, {
            headers: {
                'internal-api': process.env.INTERNAL_API_KEY
            }
        });
